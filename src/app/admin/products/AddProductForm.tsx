...
export function AddProductForm() {
    ...
    const onSubmit = (values: z.infer<typeof productSchema>) => {
        ...
        addProduct({ ...values, images, category: categoryName });
        form.reset();
        setImages([]);
    }
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                {images.length < 5 && (
                                    <Label htmlFor="image-upload" className="cursor-pointer aspect-square border-2 border-dashed border-muted-foreground/50 rounded-lg flex items-center justify-center">
